...
,
										"rect" : [ 883.0, 274.0, 579.0, 481.0 ],
										"bglocked" : 0,
										"defrect" : [ 883.0, 274.0, 579.0, 481.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 0,
													"fontsize" : 12.0,
													"patching_rect" : [ 330.0, 120.0, 156.0, 48.0 ],
													"id" : "obj-3",
													"fontname" : "Arial",
													"numinlets" : 1
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 0,
													"fontsize" : 12.0,
													"patching_rect" : [ 330.0, 45.0, 150.0, 48.0 ],
													"id" : "obj-9",
													"fontname" : "Arial",
													"numinlets" : 1
												}
...
, 											{
												"box" : 												{
													...
													"fontsize" : 12.0,
													"outlettype" : [ "" ],
													"patching_rect" : [ 240.0, 90.0, 75.0, 20.0 ],
													"id" : "obj-21",
													"fontname" : "Arial",
													"numinlets" : 1
												}
...
, 											{
												"box" : 												{
													...
													"fontsize" : 12.0,
													"outlettype" : [ "" ],
													"patching_rect" : [ 165.0, 330.0, 74.0, 18.0 ],
													"id" : "obj-17",
													"fontname" : "Arial",
													"numinlets" : 2
												}
...
, 											{
												"box" : 												{
													...
													"fontsize" : 12.0,
													"outlettype" : [ "", "", "" ],
													"patching_rect" : [ 60.0, 270.0, 169.0, 20.0 ],
													"id" : "obj-29",
													"fontname" : "Arial",
													"numinlets" : 1
												}
...
, 											{
												"box" : 												{
													...
													"fontsize" : 12.0,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 75.0, 165.0, 59.5, 20.0 ],
													"id" : "obj-18",
													"fontname" : "Arial",
													"numinlets" : 1,
...
, 											{
												"patchline" : 												{
													...
													"destination" : [ "obj-18", 0 ],
													"hidden" : 0,
													"midpoints" : [ 174.5, 359.0, 251.0, 359.0, 251.0, 153.0, 84.5, 153.0 ]
												}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 0,
													"fontsize" : 12.0,
													"presentation_rect" : [ 225.0, 118.0, 0.0, 0.0 ],
