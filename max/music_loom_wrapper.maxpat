{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 295.0, 192.0, 742.0, 660.0 ],
		"bglocked" : 0,
		"defrect" : [ 295.0, 192.0, 742.0, 660.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"presentation_rect" : [ 410.0, 264.0, 0.0, 0.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "sprintf \"set_player_option(:%s, %f)\"",
									"id" : "obj-7",
									"fontname" : "Arial",
									"numinlets" : 2,
									"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 300.0, 123.0, 20.0 ],
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 86.0, 75.0, 307.0, 257.0 ],
						"bglocked" : 0,
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "sprintf \"set_gesture_option(:%s, %f)\"",
									"id" : "obj-7",
									"fontname" : "Arial",
									"numinlets" : 2,
									"fontsize" : 12.0,
